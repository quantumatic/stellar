...
///
/// ```
/// use stellar_name_resolution::{path, Path};
...
/// Data that Stellar compiler has about a module.
...
pub struct ModuleScope {
    ...
    pub imports: FxHashMap<IdentifierID, stellar_ast::Path>,
}

/// Data the Stellar compiler has about a particular enum.
#[derive(Debug, PartialEq, Eq, Clone)]
pub struct EnumData {
    /// Enum items.
