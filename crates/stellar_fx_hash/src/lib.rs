//! Defines [`FxHashMap`] and [`FxHashSet`] which use `fx` hash algorithm.
//!
//! See [`FxHasher`] for more details.
...
/// out-performs an FNV-based hash within Stellar itself -- the collision rate is
