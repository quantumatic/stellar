//! # Token
//!
//! Token is a grammatical unit of the Stellar programming language. It is defined
...
//! the parser defined in [`stellar_parser`] crate.
//!
...
///
/// [`DUMMY_LOCATION`]: stellar_filesystem::location::DUMMY_LOCATION
#[macro_export]
macro_rules! dummy_identifier {
    ($id:expr) => {
        $crate::IdentifierAST {
            id: $id,
            location: stellar_filesystem::location::DUMMY_LOCATION,
        }
    };
}
