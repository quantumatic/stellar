...
pub struct HIRStorage {
    module_items: FxHashMap<DefinitionID, stellar_hir::ModuleItem>,
}

impl IntoIterator for HIRStorage {
    type Item = (DefinitionID, stellar_hir::ModuleItem);
    type IntoIter = hash_map::IntoIter<DefinitionID, stellar_hir::ModuleItem>;
...
impl HIRStorage {
    ...
    pub fn resolve_type_alias(
        &self,
        definition_id: DefinitionID,
    ) -> Option<&stellar_hir::TypeAlias> {
        match self.resolve_module_item(definition_id)? {
            stellar_hir::ModuleItem::TypeAlias(alias) => Some(alias),
            _ => None,
        }
    }
    ...
    #[inline(always)]
    pub fn resolve_type_alias_or_panic(
        &self,
        definition_id: DefinitionID,
    ...
    #[inline(always)]
    pub fn add_module_item(&mut self, definition_id: DefinitionID, hir: stellar_hir::ModuleItem) {
    ...
    pub fn extend(
        &mut self,
        items: impl IntoIterator<Item = (DefinitionID, stellar_hir::ModuleItem)>,
    ) {
