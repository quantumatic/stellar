...
use stellar_name_resolution::ModuleScope;
use stellar_stable_likely::unlikely;
use stellar_thir::generic_parameter_scope::{GenericParameterData, GenericParameterScope};
use stellar_thir::ty::Type;
use stellar_thir::Predicate;
...
impl TypeCheckingContext<'_, '_, '_> {
    pub(crate) fn analyze_generic_parameters_and_where_predicates(
        ...
        generic_parameters_hir: &[stellar_hir::GenericParameter],
        where_predicates_hir: &[stellar_hir::WherePredicate],
    ...
    pub(crate) fn analyze_generic_parameter_bounds(
        &self,
        module_item_name_location: Location,
        parameter_hir: &stellar_hir::GenericParameter,
        bounds_hir: &[stellar_hir::TypeConstructor],
